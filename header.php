        ...
        <div class="tengah">
          <div class="head-depan tengah">
            <div class="row">
              ...
              <div class="col-md-11">
                <h1 class="judul-head">Sistem Informasi Geografis Pemetaan Tempat Kos</h1>
                <p><i class="fa fa-map-marker fa-fw"></i> Sistem Informasi yang berisi daftar kos di daerah Ketintang, Surabaya</p>
              </div>
            </div>
    ...
    <nav class="navbar navbar-default navbar-utama" role="navigation">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="data.php"><i class="fa fa-list-ul"></i> DAFTAR KOS</a></li>
            <li><a href="peta.php"><i class="fa fa-map-marker"></i> PEMETAAN TEMPAT KOS</a></li>
